...
namespace gfx
{
	...
	inline SymMat4 operator+(SymMat4 n, const SymMat4 &m)
	{
		n += m;
		return n;
	}
	...
	inline SymMat4 operator*(double s, SymMat4 m)
	{
		m *= s;
		return m;
	}

	inline SymMat4 operator*(SymMat4 m, double s)
	{
		m *= s;
		return m;
	}
	...
	inline double trace(const SymMat4 &m)
	{
		return m(0, 0) + m(1, 1) + m(2, 2) + m(3, 3);
	}

	inline SymMat4 transpose(const SymMat4 &m)
	{
		return m;
	}
